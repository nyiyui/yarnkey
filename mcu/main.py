...
from keyboard import Keyboard, UnorderedKeyboard
from simple import in_range, Timeout
#from lowpass import LowPass
#from directional import Directional
import adafruit_dotstar
from data import keys, braille_keys
...
print('meta {"version":"alicion-v2.10","board":"'+board.board_id+'"}')

with Volt(VOLT_PINS) as first:
    #with UnorderedKeyboard(dry_run=False, keys=braille_keys) as out:
